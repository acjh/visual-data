...
This json file is structured like an array of 52 JSON corresponding to 52 weeks. Each of the 52 JSON has an array of days (which logs the frequency of git commits for each day from Sunday to Saturday), the total git commits for the week and the week id.
...
In the week with week id - 1457827200, there is a total of 1 git commit and the commit is done on Friday, as seen in the array of days.
